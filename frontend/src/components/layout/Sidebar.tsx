...
export function Sidebar() {
  ...
  return (
    <aside className="hidden md:flex flex-col h-full p-4 pb-6 bg-surface-container/40 backdrop-blur-xl w-64 lg:w-72 2xl:w-80 border-r border-white/10 shadow-xl shrink-0 z-50 transition-all duration-300">
      {/* Brand Header */}
